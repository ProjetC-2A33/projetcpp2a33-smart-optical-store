...
bool Employe::ajouter()
{
    ...
    QSqlQuery query;
    query.prepare("INSERT INTO EMPLOYE (ID_EMPLOYE, NOM_EMPLOYE, PRENOM_EMPLOYE, DATE_NAISSANCE, DATE_EMBAUCHE, ETAT_CIVIL, POST, SALAIRE, NBRE_ENFANTS, ANNEES_EXPERIENCE, DIPLOME) "
...
void Employe::remplirTableWidget(QTableWidget *tableWidget)
{
    ...
    QSqlQuery query("SELECT ID_EMPLOYE, NOM_EMPLOYE, PRENOM_EMPLOYE, TO_CHAR(DATE_NAISSANCE, 'YYYY-MM-DD'), TO_CHAR(DATE_EMBAUCHE, 'YYYY-MM-DD'), ETAT_CIVIL, POST, SALAIRE, NBRE_ENFANTS, ANNEES_EXPERIENCE, DIPLOME FROM EMPLOYE");
...
bool Employe::modifier(int idEmploye)
{
    ...
    QSqlQuery query;
    query.prepare("UPDATE EMPLOYE SET NOM_EMPLOYE=:nom, PRENOM_EMPLOYE=:prenom, "
